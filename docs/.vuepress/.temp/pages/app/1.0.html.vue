<template><div><Breadcrumb /><h1 id="_1-0" tabindex="-1"><a class="header-anchor" href="#_1-0"><span>1.0</span></a></h1>
<p>Nessa versão da aplicativo fizemos várias correções de bugs, adicionamos a feature tal, etc;</p>
<h2 id="correcoes-de-bugs" tabindex="-1"><a class="header-anchor" href="#correcoes-de-bugs"><span>Correções de bugs</span></a></h2>
...
<h2 id="feature-tal" tabindex="-1"><a class="header-anchor" href="#feature-tal"><span>Feature tal</span></a></h2>
...
<h2 id="etc" tabindex="-1"><a class="header-anchor" href="#etc"><span>Etc</span></a></h2>
